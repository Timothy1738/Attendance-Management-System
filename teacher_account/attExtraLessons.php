    ...
    <div class="teacher_acc">
        ...
        <div class="container">
            ...
            <div class="viewATTadminTab">
                ...
                <a href="../teacher_account/attS4.php">S4</a>
                <a href="../teacher_account/attS5.php">S5</a>
                <a href="../teacher_account/attS6.php">S6</a>
                <a class="active" href="../teacher_account/attExtraLessons.php">Extra Lessons</a>
            </div>

            <?php
            $getAttendance = getAttendanceRecordsExtraLessons($teacherID);
            ...
            <?php } else { ?>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $attendance['OverrideDate'] ?></td>
                        <td><?php echo $attendance['IsPresent'] ?></td>
                        <td><?php echo $attendance['Time'] ?></td>
                        <td>
                            <form action="../teacher_account/editExtralessons.php?fn=<?= $attendance['FirstName']?>&ln=<?= $attendance['LastName']?>" method="post">
                                <input type="hidden" name="recordID" value="<?php echo $attendance['OverrideID'] ?>">
