...
if (isset($_POST['update'])) {
    ...
    if ($reset == "success") {
        ...
        $admin_msg = "Teacher" . ' ' . $fname . ' ' . $lname . ' ' . "just Edited Attendance of"  . ' ' . $firstname . ' ' . $lastname;
        $admin_state = 0;
...
<body>
    <div class="edit-info">
        ...
        <a href="../teacher_account/view-attendance.php">
            <div class="return">
        ...
        <form method="post">
            ...
            <div class="input">
                ...
                <input type="text" placeholder="absent/present" name="status" value="<?php echo isset($edit['IsPresent']) ? $edit['IsPresent'] : ''; ?>" required>
            </div>
