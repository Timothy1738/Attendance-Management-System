...
if (isset($_SESSION['subject'])) {
    if (isset($_POST['submit'])) {
        ...
        if ($result) {
            ...
            $admin_msg = "Teacher" . ' ' . $fname . ' ' . $lname . ' ' . "has taken attendance, Extra Lesson for Class S6";
            $admin_state = 0;
    ...
    <div class="teacher_acc">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                ...
                <a href="../teacher_account/xtraS3.php">s3</a>
                <a href="../teacher_account/xtraS4.php">s4</a>
                <a href="../teacher_account/xtraS5.php">s5</a>
                <a class="active" href="../teacher_account/xtraS6.php">s6</a>
            </nav>
