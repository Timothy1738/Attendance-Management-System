...
if (isset($_SESSION['subject'])) {
    if (isset($_POST['submit'])) { 
        ...
        if ($result) {
            ...
            $admin_msg = "Teacher" . ' ' . $fname . ' ' . $lname . ' ' . "has taken attendance, Extra Lesson for Class S1";
            $admin_state = 0;
...
<body>
    <div class="teacher_acc">
        ...
        <div class="container">
            ...
            ?>
            <h1 class="std-header">Extra Lessons</h1>
            <nav class="viewATTadminTab">
                <h3 style="color: var(--color-white);">Select Class</h3>
                <a class="active" href="../teacher_account/extraLessons.php">s1</a>
