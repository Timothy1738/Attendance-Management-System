...
if (isset($_SESSION['subject'])) {
    if (isset($_POST['submit'])) {
        ...
        if ($result) {
            ...
            $admin_msg = "Teacher" . ' ' . $fname . ' ' . $lname . ' ' . "has taken attendance, Extra Lesson for Class S2";
            $admin_state = 0;
    ...
    <section class="teacher_acc">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                ...
                <a class="active" href="../teacher_account/xtraS2.php">s2</a>
