    ...
    <div class="view-activity">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                ...
                <a class="active" href="../admin_account/s6.php">S6</a>
                <a href="../admin_account/extra.php">Extra Lessons</a>
            </nav>


            <section class="adminSection" id="s6">
                <h3 style="color: var(--color-primary);">Class Attendance Senior Six</h3>
                <?php
                if (s6attendance() == false) { ?>
                    <div class="empty">
