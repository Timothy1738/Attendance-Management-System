    ...
    <div class="view-activity">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                ...
                <a class="active" href="../admin_account/s5.php">S5</a>
                <a href="../admin_account/s6.php">S6</a>
                <a href="../admin_account/extra.php">Extra Lessons</a>
            </nav>

            <section class="adminSection" id="s5">
                <h3 style="color: var(--color-primary);">Class Attendance Senior Five</h3>
                <?php
                if (s5attendance() == false) { ?>
                    <div class="empty">
                        <p>Attendance Has not been recorded for this class Yet</p>
                    </div>
                <?php } else { ?>
                    <table>
                        <tr>
