    ...
    <div class="view-activity">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                ...
                <a class="active" href="../admin_account/s3.php">S3</a>
            ...
            <section class="adminSection" id="s3">
                <h3 style="color: var(--color-primary);">Class Attendance Senior Three</h3>
                <?php
                if (attendanceS3() == false) { ?>
                    <div class="empty">
