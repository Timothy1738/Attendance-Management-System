...
if (isset($_POST['delete'])) {
    ...
    $delete = deleteRecordExtraLesson($id);
    if ($delete == "success") {
    ...
    <div class="view-activity">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                ...
                <a href="../admin_account/s4.php">S4</a>
                <a href="../admin_account/s5.php">S5</a>
                <a href="../admin_account/s6.php">S6</a>
                <a class="active" href="../admin_account/extra.php">Extra Lessons</a>
            </nav>


            <section class="adminSection" id="extra">
                <h3 style="color: var(--color-primary);">Class Attendance Extra Lessons</h3>
                <?php
                if (ExtraLessons() == false) { ?>
                    <div class="empty">
                        <p>Attendance has not yet been recorded for this class yet!
                        </p>
                    </div>
                <?php } else { ?>
                    <table>
                        ...
                        <?php
                        $attendance = ExtraLessons();
                        foreach ($attendance as $attend) :
                        ?>
                            <tr>
                                <td><?php echo $attend['OverrideID'] ?></td>
                                <td><?php echo $attend['FirstName'] . ' ' . $attend['LastName'] ?></td>
                                <td><?php echo $attend['Firstname'] . ' ' . $attend['Lastname'] ?></td>
                                <td><?php echo $attend['ClassName'] ?></td>
                                <td><?php echo $attend['OverrideDate'] ?></td>
                                <td><?php echo $attend['IsPresent'] ?></td>
                                <td><?php echo $attend['Time'] ?></td>

                                

                                <td>
                                    <form method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                        <input type="hidden" name="delete_record" value="<?php echo $attend['OverrideID']; ?>">
