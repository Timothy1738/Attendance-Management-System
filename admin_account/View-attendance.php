    ...
    <div class="view-activity">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                <a class="active" href="../admin_account/View-attendance.php">S1</a>
            ...
            <section class="adminSection" id="s1">
                <h3 style="color: var(--color-primary);">Class Attendance Senior One</h3>
                <?php
                if (getAttendanceRecordsS1AdminAcc() == false) { ?>
                    <div class="empty">
                ...
                <?php } else { ?>
                    <table>
                        ...
                        <?php
                        $attendance = getAttendanceRecordsS1AdminAcc();
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                        <input type="hidden" name="delete_id" value="<?php echo $attend['RecordID']; ?>">
