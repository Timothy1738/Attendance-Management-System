    ...
    <div class="view-activity">
        ...
        <div class="container">
            ...
            <nav class="viewATTadminTab">
                ...
                <a class="active" href="../admin_account/s2.php">S2</a>
            ...
            <section class="adminSection" id="s2">
                <h3 style="color: var(--color-primary);">Class Attendance Senior Two</h3>
                <?php
                if (studentsAttendanceSenior2() == false) { ?>
                    <div class="empty">
                ...
                <?php } else { ?>
                    <table>
                        ...
                        <?php
                        $attendance = studentsAttendanceSenior2();
